...
gweight = read.csv(file = "data/Supplement/spectra_rotation_matrix-gene_centers-2021-06-01.csv.gz") %>% data.table()
#head(gweight)

# Baseline spectra standard deviation values
base_sd = read.csv(file = "data/Supplement/commpass_baseline_spectra_sds_20210602.csv") %>% data.table()
#head(base_sd)
...
```{r}
write.csv(tme.sd,file = "data/Supplement/Spectra_Variables_CoMMpass_Followup_Samples.csv",row.names = FALSE)
```
